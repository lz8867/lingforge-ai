...
const pageContracts = {
  ...
  'modeling-demo.html': [
    ...
    'createCharacterReliefGeometry',
    'applyCharacterSurfaceDepth',
    'addCharacterVolumeShell',
    'createCharacterSideWallGeometry',
    'createCharacterBackShell',
    'addCharacterAmbientHalo',
    'canvasToPngBytes',
    'appendCharacterReliefSplatRows',
    '人物轮廓体积侧壁',
    '人物合成背壳',
    '人物无边界环境光晕',
    '人物接触阴影',
